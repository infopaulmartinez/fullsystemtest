              ...
              {filteredContacts.map((contact) => (
                <div
                  ...
                  className={`p-4 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer ${
                    selectedContact?.id === contact.id ? 'bg-gray-100 dark:bg-gray-700' : contact.unread_count > 0 ? 'bg-amber-50 dark:bg-amber-900/30' : ''
                  }`}
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex justify-between items-center mt-1">
                        ...
                        {contact.unread_count > 0 && (
                          <span className="inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-gray-900 bg-amber-300 rounded-full">
